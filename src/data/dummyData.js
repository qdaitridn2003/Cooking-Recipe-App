...
const pineapple = new Material(19, 'Da');
...
const ice = new Material(43, 'Đá Lạnh');
...
const noodlesMaterial = [noodles, chicken, vegetable, lemongrass, chilli, garlic, fishsauce, oil, salt, fishsauce, lemon, oil, sugar, chilli];
...
const r1 = new Recipe(0, 'Bánh sanwich nướng bơ', 'https://image.cooky.vn/recipe/g4/33949/s640/cooky-recipe-cover-r33949.jpg', '20 phút', '100 Kcal', breakfast, breadMaterial, breadGuide);
const r2 = new Recipe(1, 'Mỳ gà', 'https://cdn.tgdd.vn/Files/2019/08/07/1185290/cach-nau-mi-quang-ga-ngon-dam-da-dung-vi-mien-trung-202106211351007621.jpg', '1 giờ', '250 Kcal', breakfast, noodlesMaterial, noodlesGuide);
...
const r7 = new Recipe(6, 'Bánh sanwich nướng bơ', 'https://image.cooky.vn/recipe/g4/33949/s640/cooky-recipe-cover-r33949.jpg', '20 phút', '100 Kcal', sideDishes, breadMaterial, breadGuide);
