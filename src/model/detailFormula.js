...
// type
const breakfask = new Type(0, 'ăn sáng');
const appetizer = new Type(1, 'khai vị');
const mainDishes = new Type(2, 'món chính');
const sideDisher = new Type(3, 'món ăn kèm');
...
const vetetables = new Material(6, 'rau');
const lemongrass = new Material(7, 'cộng sả');
const chili = new Material(8, 'ớt');
const garlic = new Material(9, 'tỏi');
const fishsauce = new Material(10, 'nước mắm');
const oil = new Material(11, 'dầu');
const salt = new Material(12, 'muối');
const noodles = new Material(13, 'mỳ');
...
const pineapple = new Material(19, 'dứa');
...
const tapiocaPowder = new Material(26, 'bột năng');
const rice = new Material(27, 'gạo');
const turmeric = new Material(28, 'nghệ');
const ginger = new Material(29, 'gừng');
const squid = new Material(30, 'Mực');
const shrimp = new Material(31, 'Tôm');
const friedDough = new Material(32, 'bột chiên giòn');
const coconutMilk = new Material(33, 'Nước cốt dừa');
const wine = new Material(34, 'rượu');
const apple  = new Material(35, 'táo');
const orange = new Material(36, 'cam');
const mango = new Material(37, 'xoài');
const watermelon = new Material(38, 'dưa hấu');
const longan = new Material(39, 'nhãn');
const grape = new Material(40, 'nho');
const strongBow = new Material(41, 'Strong Bow');
const kiwi = new Material(41, 'kiwi');
const sevenUp = new Material(42, '7 up');
const pennywort = new Material(42, 'rau má');
const stone = new Material(43, 'viên đá');
...
const noodlesMaterial = [noodles, chicken, vetetables, lemongrass, chili, garlic, fishsauce, oil, salt, fishsauce, lemon, oil, sugar, chili];
...
const beefMaterial = [beef, banana, pineapple, starfruit, onion, peanuts, vetetables,]
...
const squidMaterial = [squid, carrot, onion, lemon, water, ginger, sugar, chili, fishsauce, salt, pepper]
...
const shrimpMaterial = [shrimp, egg, friedDough, oil, sugar, chili, fishsauce, salt, pepper]
...
const cocktailMaterial = [pineapple, kiwi, orange, grape, watermelon, apple, stone]
...
const pennywortMaterial = [pennywort, water, sugar, stone]
...
const r1 = new Recipe(0, 'Bánh sanwich nướng bơ', 'https://image.cooky.vn/recipe/g4/33949/s640/cooky-recipe-cover-r33949.jpg', '20 phút', '100 Kcal', breakfask, breadMaterial, breadGuide);
const r2 = new Recipe(1, 'Mỳ gà', 'https://cdn.tgdd.vn/Files/2019/08/07/1185290/cach-nau-mi-quang-ga-ngon-dam-da-dung-vi-mien-trung-202106211351007621.jpg', '1 giờ', '250 Kcal', breakfask, noodlesMaterial, noodlesGuide);
...
const r7 = new Recipe(6, 'Bánh sanwich nướng bơ', 'https://image.cooky.vn/recipe/g4/33949/s640/cooky-recipe-cover-r33949.jpg', '20 phút', '100 Kcal', sideDisher, breadMaterial, breadGuide);
const r8 = new Recipe(7, 'Tôm chiên xù', 'https://cdn.tgdd.vn/2021/07/CookRecipe/Avatar/tom-chien-xu-nguyen-vo-thumbnail.jpg', '60 phút', '170 Kcal', sideDisher, shrimpMaterial, shrimpGuide);
...
const r10 = new Recipe(9, 'Trái cây', 'https://pastaxi-manager.onepas.vn/content/uploads/articles/mon-an-vat-hai/35-trang-tri-hoa-qua/qua-1.jpg', '20 phút', '200 Kcal', dessert, fruitMaterial, null);
